...
data_date = "2026-03-27"  # date xenium_preprocess_lowres.py was run
model_date = date.today()
adata = ad.read_h5ad(f"data/xenium_sample1_filtered_lowres_{data_date}.h5ad")
adata_train = ad.read_h5ad(f"data/xenium_sample1_filtered_lowres_train_{data_date}.h5ad")
adata_test = ad.read_h5ad(f"data/xenium_sample1_filtered_lowres_test_{data_date}.h5ad")

saved_models_dir = f"saved_models/xenium_sample1_lowres_sweep_{data_date}_model_{model_date}"
project_name = f"xenium_sample1_lowres_sweep_{data_date}_model_{model_date}"
