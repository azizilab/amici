...
cell_type_pairs = [
    {
        ...
        "genes": ["CCND1", "KDR", "KRT7"],
        "label": "Invasive Tumor → Endothelial"
    },
    {
        "sender_type": "Invasive_Tumor",
        "receiver_type": "Stromal",
        "genes": ["KRT7", "FOXA1", "KRT8", "FASN", "GATA3", "EPCAM", "CCND1", "SCD"],
        "label": "Invasive Tumor → Stromal"
    },
    {
        "sender_type": "Invasive_Tumor",
        "receiver_type": "Macrophages_1",
        "genes": ["KRT7", "FOXA1", "ERBB2", "FASN", "CCND1", "FCER1G"],
        "label": "Invasive Tumor → Macrophages_1"
    },
    {
        "sender_type": "CD4+_T_Cells",
        "receiver_type": "B_Cells",
        "genes": ["MS4A1", "BANK1", "PTPRC", "SELL", "LTB", "CD19", "SPIB", "CXCR4"],
        "label": "CD4+ T Cells → B Cells"
    },
    {
        "sender_type": "Myoepi_ACTA2+",
        "receiver_type": "DCIS 2",
        "genes": ["ACTA2", "MYLK", "KRT14", "DST", "SFRP1", "ACTG2"],
        "label": "Myoepi ACTA2+ → DCIS 2"
    },
    {
        "sender_type": "Stromal",
        "receiver_type": "Macrophages_1",
        "genes": ["POSTN", "LUM", "CCDC80", "FGL2", "FCER1G"],
        "label": "Stromal → Macrophages_1"
    }
]
near_threshold = 20.0
far_threshold = 100.0
...
def plot_segmentation_test_results(
    ...
    # Customize the plot
    ax.set_xlabel('Max Mann-Whitney U p-value across both segmentation checks', fontsize=14)
    ax.set_ylabel('Genes by Cell Type Pair', fontsize=14)
